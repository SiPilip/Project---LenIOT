...
Props over keyframes - Use initial, animate, exit props instead of CSS keyframes
Variants for orchestration - Group related animations and control timing with parent-child relationships
...
{/_ New page waits for old page to exit _/}
</motion.div>
</AnimatePresence>
// mode="sync" (default) - enter and exit simultaneously
<AnimatePresence mode="sync">
{/_ Elements animate at the same time _/}
</AnimatePresence>
// mode="popLayout" - for shared layout transitions
<AnimatePresence mode="popLayout">
{/_ Animates layout changes during exit \*/}
</AnimatePresence>
...
transition: { duration: SHAKE_DURATION_S _ SHAKE_TIMES },
});
}
}, [hasError, controls]);
