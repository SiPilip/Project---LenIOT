...
| 2026-09-19 | 46 Java Geospatial Dataset & Seeder CLI | Menyusun 46 entitas geospasial realistis di seluruh Pulau Jawa (DKI Jakarta, Banten, Jawa Barat, Jawa Tengah, D.I. Yogyakarta, Jawa Timur) dengan atribut dinamis lengkap, mengonfigurasi CLI seeder `go run ./cmd/seed` dengan opsi `-reset`, serta memusatkan viewport peta default ke Pulau Jawa ([110.0, -7.2], zoom 7.2) | Verifikasi sebaran 46 titik data di peta Jawa dengan klasterisasi dan heatmap yang dinamis |
