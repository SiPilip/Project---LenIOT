...
| 2026-09-19 | Premium 3-Tier Radar Cluster & Retina SVG Pins | Meningkatkan estetika visual klaster dan mark pada mode Clusters: klaster kini menggunakan 3 lapisan kedalaman (outer radar pulse aura, white relief ring, core emerald disc ber-border putih, dan tipografi tebal angka klaster), sedangkan titik unclustered menggunakan pin SVG teardrop retina berglif react-icons (FaTruck, FaWifi, FaWarehouse, FaLocationDot), manik status dot, dan halo seleksi aktif | Konfirmasi peningkatan visual mark klaster dan pin mandiri |
