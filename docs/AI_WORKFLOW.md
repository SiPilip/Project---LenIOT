...
| 2026-09-19 | Pure Spreading Density Heatmap Refinement | Menghilangkan titik-titik penanda pada mode Heatmap sesuai permintaan pengguna agar murni berupa gradasi sebaran densitas spasial, mempertebal intensitas warna (opacity 0.85, bobot 1.2, 7-stop interpolasi hijau ColorBrewer #c7e9c0 s/d #00441b), serta memperluas radius difusi hingga 135px agar transisi warna halus, lembut, dan menyebar alami | Verifikasi visual sebaran gradasi heatmap murni tanpa titik |
