...
| 2026-09-19 | Scale Cluster Unclustered Pins to Match Pinpoint Mode | Menyesuaikan dimensi pin mandiri (unclustered) pada mode Clusters agar ukurannya sama persis (36px wide x 45px tall) dengan pin pada mode Pinpoints: memperbesar SVG canvas ke 96x120 pada pixelRatio 2, menaikkan icon-size ke 1.0, serta memperluas radius selection halo menjadi 28px | Konfirmasi ukuran pin mandiri pada mode klaster kini identik dengan mode pinpoints |
